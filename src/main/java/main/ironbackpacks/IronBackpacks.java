...
@Mod(modid = ModInformation.ID, name = ModInformation.NAME, version = ModInformation.VERSION, dependencies = ModInformation.DEPEND)//removed gui factory for now, guiFactory = ModInformation.GUIFACTORY)
