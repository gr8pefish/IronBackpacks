...
public interface ITieredBackpack extends IBackpack { //TODO: use a tree datatype?
     ...
     *
     * @param baseBackpack - the backpack as an items stack (needed for sub items) to set this value for
     ...
     *
     * @param backpack - the backpack as an items stack (needed for sub items) to set this value for
     ...
     * @param backpack - the backpack as an items stack (needed for sub items) to get this value for.
