...
public class CraftingItemRegistry {
    ...
    public static void registerCraftingItemTexture(ItemAPICrafting item, String modelName) {
        int meta = getIndexOf(item);
        ResourceLocation resourceLocation = new ResourceLocation(Constants.DOMAIN + modelName);

        ModelBakery.registerItemVariants(IronBackpacksAPI.getItem(IronBackpacksAPI.ITEM_CRAFTING), resourceLocation);
        ModelLoader.setCustomModelResourceLocation(IronBackpacksAPI.getItem(IronBackpacksAPI.ITEM_CRAFTING), meta, new ModelResourceLocation(resourceLocation, "inventory"));
    }
