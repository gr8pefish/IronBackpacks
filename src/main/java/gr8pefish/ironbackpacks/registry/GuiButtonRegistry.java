...
public class GuiButtonRegistry {
    ...
    public static void registerButtons(){
        ...
        registerButton(ButtonNames.VOID, new IBGuiButton(5, 16, 5, 0, 115, false, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.void.tooltip"))));
        registerButton(ButtonNames.CLEAR_ROW, new IBGuiButton(6, 11, 12, 64, 64, true, TextUtils.cutLongString(TextUtils.localizeEffect("")))); //6,7,8 because can clear 3 rows
        registerButton(ButtonNames.BACKPACK_TO_INVENTORY, new IBGuiButton(9, 11, 12, 64, 0, true, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.packToInv.tooltip"))));
        registerButton(ButtonNames.INVENTORY_TO_BACKPACK, new IBGuiButton(10, 11, 12, 64, 16, true, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.invToPack.tooltip"))));
        registerButton(ButtonNames.HOTBAR_TO_BACKPACK, new IBGuiButton(11, 11, 12, 64, 32, true, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.barToPack.tooltip"))));
        registerButton(ButtonNames.SORT_BACKPACK, new IBGuiButton(12, 11, 12, 64, 48, true, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.sort.tooltip"))));
        registerButton(ButtonNames.MOVE_LEFT, new IBGuiButton(13, 4, 9, 18, 57, true, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.left.tooltip"))));
        registerButton(ButtonNames.MOVE_RIGHT, new IBGuiButton(14, 4, 9, 18, 37, true, TextUtils.cutLongString(TextUtils.localizeEffect("button.ironbackpacks.right.tooltip"))));
    ...
    public static void setAdvancedFilterButtons(){
        advFilterButtons = new IBGuiButton[]{getButton(ButtonNames.EXACT), getButton(ButtonNames.FUZZY), getButton(ButtonNames.ORE_DICT), getButton(ButtonNames.MOD_SPECIFIC), getButton(ButtonNames.VOID)};
    }
