...
public class LayerBackpack implements LayerRenderer<AbstractClientPlayer> {
    ...
    public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float f1, float f2, float f3, float f4, float f5, float f6, float scale)
    {
...
//            }
    ...
    private void renderPack(AbstractClientPlayer clientPlayer, ModelPlayer modelPlayer){
